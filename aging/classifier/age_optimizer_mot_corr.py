...
#
#
## R2 as a function of descriptor number
#lm = LinearRegression()
...
#            r2_val[j] = metrics.r2_score(y_test, y_pred)
#    
#        if np.mean(r2_val) > results[i]:
...
#    
#
#np.save('best_idx_ext_int_shuf.npy', best_idx_list)
#np.save('ordered_data_ext_int_shuf.npy',ordered_data)
#np.save('results_ext_int_shuf.npy', results)
#np.save('sigma_ext_int_shuf.npy', sigma)
